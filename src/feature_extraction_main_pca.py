...
if __name__ == '__main__':
    DATA_DIR = '../data/Preprocessed_split/test_subjects'  # Update if needed
    X, y = load_data_and_extract_features(DATA_DIR, apply_pca=True, n_components=100, remove_rest=True)
